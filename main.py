...
# Cache the data reading function to improve performance
@st.cache_data
def read_data():
...
# Cache the date formatting function to improve performance
@st.cache_data
def format_date_for_comparison(date):
    # Convert the date to a float for comparison purposes
    if date[1] == 2:
...
# Cache the function to check if the end date is before the start date
@st.cache_data
